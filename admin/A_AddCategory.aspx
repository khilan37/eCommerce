<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="A_AddCategory.aspx.cs" Inherits="A_AddCategory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="main-part">
            <div class="title">
                <h1>Add Category</h1>
                <a href="A_CategoryList.aspx"><i class="fa fa-angle-left"></i>Back</a>
            </div>
            <div class="card">
